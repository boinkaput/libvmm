...
package_guest_images.o: $(VMM_TOOLS)/package_guest_images.S $(IMAGE_DIR) $(LINUX) $(INITRD) $(DTB)
...
vmm.elf: vmm.o libvmm.a
	$(LD) $(LDFLAGS) $^ $(LIBS) -o $@

vmm.o: ${EXAMPLE_DIR}/vmm.c

include ${VMM}/vmm.mk

$(IMAGE_FILE) $(REPORT_FILE): vmm.elf $(SYSTEM_DESCRIPTION) $(IMAGE_DIR)
